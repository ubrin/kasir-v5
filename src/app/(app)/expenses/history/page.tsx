...
import { MoreHorizontal, Loader2, ArrowLeft, PlusCircle, Edit, Trash2, Repeat, Receipt, Package } from 'lucide-react';
...
const getCategoryIcon = (category: Expense['category']) => {
    switch(category) {
        case 'utama': return <Badge variant="outline" className="bg-blue-100 text-blue-800"><Repeat className="mr-1 h-3 w-3"/>Utama</Badge>;
        case 'angsuran': return <Badge variant="outline" className="bg-purple-100 text-purple-800"><Receipt className="mr-1 h-3 w-3"/>Angsuran</Badge>;
        case 'lainnya': return <Badge variant="outline" className="bg-orange-100 text-orange-800"><Package className="mr-1 h-3 w-3"/>Lainnya</Badge>;
        default: return null;
    }
}
        ...
        <div className="flex flex-col gap-8">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Riwayat Pengeluaran</h1>
                        <p className="text-muted-foreground">Daftar semua transaksi pengeluaran yang tercatat.</p>
                    </div>
                </div>
                        ...
                        <TableBody>
                            {expenses.length > 0 ? expenses.map(expense => (
                                <TableRow key={expense.id}>
                                    ...
                                    <TableCell>{getCategoryIcon(expense.category)}</TableCell>
