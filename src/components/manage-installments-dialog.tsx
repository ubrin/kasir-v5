...
export function ManageInstallmentsDialog({ installments, onDelete, children }: ManageInstallmentsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle>Kelola Templat Angsuran</DialogTitle>
          <DialogDescription>
            Ubah atau hapus templat untuk pengeluaran angsuran Anda.
          </DialogDescription>
        </DialogHeader>
        <div className="py-4">
          {installments.length > 0 ? (
            <Table>
             ...
             <div className="flex flex-col items-center justify-center h-48 gap-2 text-center">
                ...
                <p className="text-muted-foreground">Anda belum menambahkan templat angsuran.</p>
            </div>
          )}
        </div>
      </DialogContent>
